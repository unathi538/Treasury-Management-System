...
// ✅ Choose the correct POST handler.
// If you really use /backend/auth/login.php keep it.
// Otherwise change to /backend/login.php (if that’s your handler).
$loginAction = '/backend/auth/login.php';
?>
<!doctype html>
<html lang="en">
<head>
...
<div class="container">
  ...
  <div class="subtitle">Community Savings Pool</div>

  <?php if ($error): ?>
    <div class="error"><?php echo htmlspecialchars((string)$error, ENT_QUOTES, 'UTF-8'); ?></div>
  <?php endif; ?>

  <form method="POST" action="<?php echo htmlspecialchars($loginAction, ENT_QUOTES, 'UTF-8'); ?>">
